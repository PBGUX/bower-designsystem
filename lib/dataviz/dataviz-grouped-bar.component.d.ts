...
import { PbdsDatavizGroupedBar } from './dataviz.interfaces';
export declare class PbdsDatavizGroupedBarComponent implements OnInit, OnDestroy, OnChanges {
    private _dataviz;
    private _element;
    private _scroll;
    private _location;
    ...
    data: Array<PbdsDatavizGroupedBar>;
    width: number;
    height: number;
    vertical: boolean;
    hideXAxis: boolean;
